...
/**
 * A materials.Clause is a disjunction of multiple variables with or without a negation materials.getPredicate
 */
open class Clause constructor(disjunction : Array<Literal>)
{
//    private var vars : Array<materials.Variable> = disjunction.map { a -> a.first }.toTypedArray();
